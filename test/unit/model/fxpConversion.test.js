const { MetricsModel } = require("@internal/model");
...
describe("FxpConversion Model", () => {
  ...
  test('should return mock data when mockData is true', async () => {
    ...
    const opts = { startTimestamp: '2024-01-01T00:00:00Z', startTimestamp: '2024-01-07T00:00:00Z' };
    const mockStatusSummary = [
      { status: 'success', count: 10 },
      { status: 'failed', count: 5 },
    ];

    mock.getFxpConversionStatusSummary = jest.fn().mockResolvedValue(mockStatusSummary);
