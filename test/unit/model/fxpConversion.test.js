...
describe('FxpConversion Model', () => {
    ...
    describe('_joinFxQuotesAndFxTransfers method', () => {
    ...
    describe('_fxpConversionLastErrorToErrorType method', () => {
    ...
    describe('_parseRawTransferRequestBodies method', () => {
    ...
    describe('_calculateTotalChargesFromCharges method', () => {
    ...
    describe('_getConversionTermsFromFxQuoteResponse method', () => {
    ...
    describe('_getQuoteAmountFromFxQuoteRequest method', () => {
    ...
    describe('_getConversionState method', () => {
    ...
    describe('details method', () => {
        ...
        test('should return converted API detail format for fxpconversion details if data is found in the database when mockdata is false', async () => {
            ...
            expect(fxpConversion._joinFxQuotesAndFxTransfers).toHaveBeenCalledTimes(
                1
            );
    ...
    describe('statusSummary method', () => {
        test('should return mock data when mockData is true', async () => {
            fxpConversion.mockData = true;
            const opts = {
                startTimestamp: '2024-01-01T00:00:00Z',
                endTimestamp: '2024-01-07T00:00:00Z',
            };
            ...
            mock.getFxpConversionStatusSummary = jest
                .fn()
                .mockResolvedValue(mockStatusSummary);

            const result = await fxpConversion.statusSummary(opts);

            expect(mock.getFxpConversionStatusSummary).toHaveBeenCalledWith(opts);
            expect(result).toEqual([
                { status: 'success', count: 10 },
                { status: 'failed', count: 5 },
            ]);
    ...
    describe('_convertToApiDetailFormat', () => {
        const baseFxpConversionData = {
