...
*/}}
{{- define "pm4ml-experience-api.name" -}}
...
*/}}
{{- define "pm4ml-experience-api.fullname" -}}
...
*/}}
{{- define "pm4ml-experience-api.chart" -}}
...
Common labels
*/}}
{{- define "pm4ml-experience-api.labels" -}}
app.kubernetes.io/name: {{ include "pm4ml-experience-api.name" . }}
helm.sh/chart: {{ include "pm4ml-experience-api.chart" . }}
